...
/* 메인 영화검색에서 넘어오는 변수 검색결과에 일치하는 영화가있을시 search = 1 */
...
ArrayList<String> list = (ArrayList)session.getAttribute("session_movie_no");
	...
	/* 세션값을 삭제합니다. */
	session.removeAttribute("session_movie_no"); 
...
<section>
    ...
    %>
      <div class="a">
      <div class="fakeimg" onclick="location='movieDetail.jsp?m_no=<%=movienum.get(i)%>'" 
      style="background-image:url('img/<%=movienum.get(i)%>.jpg')" ></div>
